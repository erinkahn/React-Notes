Examples of when to use the useEffect hook / side effects:
...
* So useEffect runs after every render and after every update 
...
* Explanation of above: we pass [count] as the second argument. What does this mean? If the count is 5, and then our component re-renders with count still equal to 5, React will compare [5] from the previous render and [5] from the next render. Because all items in the array are the same (5 === 5), React would skip the effect. That’s our optimization.
