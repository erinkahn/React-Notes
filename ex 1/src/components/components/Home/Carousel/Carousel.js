    ...
    <Container className="carousel-container" fluid>
      ...
      <div ref={ref} className="container-fluid inner-wrapper">
        ...
        <Row className="carousel-content">
          <Col className="pager-wrapper d-flex" xs="6 justify-content-center" md="2 justify-content-start">
            <button
          ...
          <Col className="pager-wrapper d-flex" xs="6 justify-content-center" md="2 justify-content-end">
